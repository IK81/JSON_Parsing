...
public static void main(String[] args) throws IOException {
		...
		URL urlGB = new URL ("http://www.geoplugin.net/json.gp?ip=217.10.136.10");
		...
		final String element_03 = "geoplugin_countryName";
		final String element_04 = "geoplugin_latitude";
		final String element_05 = "geoplugin_longitude";

		String element_name_01 = "City: ";
		String element_name_02 = "State: ";
		String element_name_03 = "Country: ";
		String element_name_04 = "Latitude: ";
		String element_name_05 = "Longitude: ";
		...
		if (e == Event.KEY_NAME) {
			...
			case element_05:
				parser1.next();
				System.out.println(element_name_05 + parser1.getString());
				System.out.println("///////////////////////////////////");
			break;
			}
...
case element_05:
	parser2.next();
	System.out.println(element_name_05 + parser2.getString());
	System.out.println("///////////////////////////////////");
break;
}
...
case element_05:
parser3.next();
System.out.println(element_name_05 + parser3.getString());
System.out.println("///////////////////////////////////");
break;
}
...
case element_05:
parser4.next();
System.out.println(element_name_05 + parser4.getString());
System.out.println("///////////////////////////////////");
break;
}
...
case element_05:
parser5.next();
System.out.println(element_name_05 + parser5.getString());
System.out.println("///////////////////////////////////");
break;
}
